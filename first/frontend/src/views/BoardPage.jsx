...
class BoardPage extends Component{
    ...
    componentDidMount(){
        axios.post('http://localhost:5000/board/incontent',{
        ...
        axios.post('http://localhost:5000/board/commentlist',{
    ...
    render(){
        ...
        return(
            ...
            <a onClick={this.back} class="btn btn-primary">뒤로가기</a>
            <br></br>
            <br></br>
            <form>
            <table className="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        <td>작성일 : <Moment format = "YYYY 년 MM 월 DD 일 HH시 mm분">{this.state.created}</Moment></td>
                    </tr>
                    <tr>
            ...
            <div className="container">
                ...
                <form style={{marginLeft:"1%"}}  onSubmit={this.comment}>
                    <textarea required rows="5" cols="100" style={{border:"1px solid",outline:"solid"}} name="comment" value={this.state.comment} placeholder="댓글을 작성하세요." onChange={this.TextChange} onKeyPress={this.enter_go}></textarea>
